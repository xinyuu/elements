...
/***********************         DO NOT EDIT        ******************************
*
* First.h - Element header for ULAM
*
**********************************************************************************
...
#ifndef UE_10105FIRST0_H
#define UE_10105FIRST0_H

#include "UlamDefs.h"

#include "Ue_10105First0_Types.h"
...
namespace MFM{
  ...
  template<class EC>
  class Ue_10105First0 : public UlamElement<EC>  {
  ...
  public:
    ...
    static Ue_10105First0 THE_INSTANCE;
    Ue_10105First0();
    ~Ue_10105First0();
  ...
  template<class EC>
  Ue_10105First0<EC> Ue_10105First0<EC>::THE_INSTANCE;

} //MFM

#include "Ue_10105First0.tcc"

#endif //UE_10105FIRST0_H
