...
#ifndef UE_10105EMPTY0_H
#define UE_10105EMPTY0_H

#include "UlamDefs.h"

#include "Ue_10105Empty0_Types.h"
...
namespace MFM{
  ...
  template<class EC>
  class Ue_10105Empty0 : public UlamElement<EC>  {
  ...
  public:
    ...
    static Ue_10105Empty0 THE_INSTANCE;
    Ue_10105Empty0();
    ~Ue_10105Empty0();
  ...
  template<class EC>
  Ue_10105Empty0<EC> Ue_10105Empty0<EC>::THE_INSTANCE;

} //MFM

#include "Ue_10105Empty0.tcc"

#endif //UE_10105EMPTY0_H
