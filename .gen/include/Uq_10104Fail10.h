...
namespace MFM{
  ...
  struct Uq_10104Fail10 : public UlamClass
  {
    ...
    //! Fail.ulam:4:   Void fail() native;
    static void Uf_4fail(UlamContext<EC>& uc, T& Uv_4self); //native


    //! Fail.ulam:5:   Void fail(Int code) native;
    static void Uf_4fail(UlamContext<EC>& uc, T& Uv_4self, Ui_Ut_102321i Uv_4code); //native
