...
/***********************         DO NOT EDIT        ******************************
*
* Third.h - Element header for ULAM
*
**********************************************************************************
...
#ifndef UE_10105THIRD0_H
#define UE_10105THIRD0_H

#include "UlamDefs.h"

#include "Ue_10105Third0_Types.h"
...
namespace MFM{
  ...
  template<class EC>
  class Ue_10105Third0 : public UlamElement<EC>  {
  ...
  public:
    ...
    static Ue_10105Third0 THE_INSTANCE;
    Ue_10105Third0();
    ~Ue_10105Third0();
  ...
  template<class EC>
  Ue_10105Third0<EC> Ue_10105Third0<EC>::THE_INSTANCE;

} //MFM

#include "Ue_10105Third0.tcc"

#endif //UE_10105THIRD0_H
